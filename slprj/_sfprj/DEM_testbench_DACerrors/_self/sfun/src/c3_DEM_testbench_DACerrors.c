...
#include "c3_DEM_testbench_DACerrors.h"
...
static void initialize_c3_DEM_testbench_DACerrors
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void initialize_params_c3_DEM_testbench_DACerrors
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void enable_c3_DEM_testbench_DACerrors
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void disable_c3_DEM_testbench_DACerrors
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_DEM_testbench_DACerrors
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_DEM_testbench_DACerrors
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void set_sim_state_c3_DEM_testbench_DACerrors
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance, const mxArray
   *c3_st);
static void finalize_c3_DEM_testbench_DACerrors
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void sf_c3_DEM_testbench_DACerrors
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void initSimStructsc3_DEM_testbench_DACerrors
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void registerMessagesc3_DEM_testbench_DACerrors
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_DEM_testbench_DACerrorsInstanceStruct
  *chartInstance, const mxArray *c3_dacout, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_DEM_testbench_DACerrorsInstanceStruct
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_sum(SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance,
                     real_T c3_x_data[3], int32_T c3_x_sizes[1]);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_c_emlrt_marshallIn(SFc3_DEM_testbench_DACerrorsInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_d_emlrt_marshallIn(SFc3_DEM_testbench_DACerrorsInstanceStruct *
  chartInstance, const mxArray *c3_b_is_active_c3_DEM_testbench_DACerrors, const
  char_T *c3_identifier);
static uint8_T c3_e_emlrt_marshallIn(SFc3_DEM_testbench_DACerrorsInstanceStruct *
  chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_DEM_testbench_DACerrorsInstanceStruct
  *chartInstance);
  ...
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_DEM_testbench_DACerrors = 0U;
}
  ...
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance)
{
  ...
  c3_b_hoistedGlobal = chartInstance->c3_is_active_c3_DEM_testbench_DACerrors;
   ...
   *c3_st)
{
  ...
  *c3_dacout = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    0)), "dacout");
  chartInstance->c3_is_active_c3_DEM_testbench_DACerrors = c3_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_DEM_testbench_DACerrors");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_DEM_testbench_DACerrors(chartInstance);
  ...
  (SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance)
{
  ...
  int32_T c3_i7;
  real_T c3_b_elems_data[3];
  uint8_T *c3_b_dacin;
  real_T *c3_b_dacout;
  real_T *c3_b_rotflag;
  real_T *c3_b_numele;
  real_T (*c3_b_scramcode)[3];
  real_T (*c3_b_elems)[3];
  c3_b_scramcode = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 4);
  c3_b_elems = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 3);
  ...
  if (CV_EML_IF(0, 1, 0, c3_rotflag == 0.0)) {
    ...
    for (c3_i7 = 0; c3_i7 <= c3_b_loop_ub; c3_i7++) {
      c3_b_elems_data[c3_i7] = c3_elems[(int32_T)(real_T)
        ...
        "scramcode(1:dacin)", c3_scramcode[c3_i7]), 1, 3, 0, 0) - 1];
    }
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance;
  chartInstance = (SFc3_DEM_testbench_DACerrorsInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c3_DEM_testbench_DACerrors_get_eml_resolved_functions_info
  (void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_DEM_testbench_DACerrors), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_DEM_testbench_DACerrors);
  return c3_y;
}
...
void sf_c3_DEM_testbench_DACerrors_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1715980881U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(173059129U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1250440846U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3365568137U);
}

mxArray *sf_c3_DEM_testbench_DACerrors_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("qWnKDUl1wMTiU9wgRcnwfE");
...
mxArray *sf_c3_DEM_testbench_DACerrors_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c3_DEM_testbench_DACerrors(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"dacout\",},{M[8],M[0],T\"is_active_c3_DEM_testbench_DACerrors\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_DEM_testbench_DACerrors_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T (*c3_elems)[3];
          real_T (*c3_scramcode)[3];
          c3_scramcode = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 4);
          c3_elems = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 3);
...
{
  return "5xVWgv9Jzvn050QshZ5zRF";
}

static void sf_opaque_initialize_c3_DEM_testbench_DACerrors(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_DEM_testbench_DACerrorsInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_DEM_testbench_DACerrors
    ((SFc3_DEM_testbench_DACerrorsInstanceStruct*) chartInstanceVar);
  initialize_c3_DEM_testbench_DACerrors
    ((SFc3_DEM_testbench_DACerrorsInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_DEM_testbench_DACerrors(void *chartInstanceVar)
{
  enable_c3_DEM_testbench_DACerrors((SFc3_DEM_testbench_DACerrorsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_DEM_testbench_DACerrors(void *chartInstanceVar)
{
  disable_c3_DEM_testbench_DACerrors((SFc3_DEM_testbench_DACerrorsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_DEM_testbench_DACerrors(void *chartInstanceVar)
{
  sf_c3_DEM_testbench_DACerrors((SFc3_DEM_testbench_DACerrorsInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_DEM_testbench_DACerrors
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_DEM_testbench_DACerrors
    ((SFc3_DEM_testbench_DACerrorsInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_DEM_testbench_DACerrors();/* state var info */
...
extern void sf_internal_set_sim_state_c3_DEM_testbench_DACerrors(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_DEM_testbench_DACerrors
    ((SFc3_DEM_testbench_DACerrorsInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_DEM_testbench_DACerrors
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c3_DEM_testbench_DACerrors(S);
}

static void sf_opaque_set_sim_state_c3_DEM_testbench_DACerrors(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c3_DEM_testbench_DACerrors(S, st);
}

static void sf_opaque_terminate_c3_DEM_testbench_DACerrors(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_DEM_testbench_DACerrorsInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c3_DEM_testbench_DACerrors
      ((SFc3_DEM_testbench_DACerrorsInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_DEM_testbench_DACerrors
    ((SFc3_DEM_testbench_DACerrorsInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_DEM_testbench_DACerrors(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_DEM_testbench_DACerrors
      ((SFc3_DEM_testbench_DACerrorsInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_DEM_testbench_DACerrors(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2961590757U));
  ssSetChecksum1(S,(1818120221U));
  ssSetChecksum2(S,(2530943111U));
  ssSetChecksum3(S,(2958403263U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_DEM_testbench_DACerrors(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_DEM_testbench_DACerrors(SimStruct *S)
{
  SFc3_DEM_testbench_DACerrorsInstanceStruct *chartInstance;
  chartInstance = (SFc3_DEM_testbench_DACerrorsInstanceStruct *)utMalloc(sizeof
    (SFc3_DEM_testbench_DACerrorsInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_DEM_testbench_DACerrorsInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_DEM_testbench_DACerrors;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_DEM_testbench_DACerrors;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_DEM_testbench_DACerrors;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c3_DEM_testbench_DACerrors;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_DEM_testbench_DACerrors;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_DEM_testbench_DACerrors;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_DEM_testbench_DACerrors;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_DEM_testbench_DACerrors;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_DEM_testbench_DACerrors;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_DEM_testbench_DACerrors;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_DEM_testbench_DACerrors;
...
void c3_DEM_testbench_DACerrors_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_DEM_testbench_DACerrors(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_DEM_testbench_DACerrors(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_DEM_testbench_DACerrors(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_DEM_testbench_DACerrors_method_dispatcher.\n"
