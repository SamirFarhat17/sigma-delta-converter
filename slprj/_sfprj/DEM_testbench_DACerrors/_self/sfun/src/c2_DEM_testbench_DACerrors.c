...
#include "c2_DEM_testbench_DACerrors.h"
...
static void initialize_c2_DEM_testbench_DACerrors
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void initialize_params_c2_DEM_testbench_DACerrors
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void enable_c2_DEM_testbench_DACerrors
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void disable_c2_DEM_testbench_DACerrors
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_DEM_testbench_DACerrors
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_DEM_testbench_DACerrors
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void set_sim_state_c2_DEM_testbench_DACerrors
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_DEM_testbench_DACerrors
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void sf_c2_DEM_testbench_DACerrors
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void initSimStructsc2_DEM_testbench_DACerrors
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void registerMessagesc2_DEM_testbench_DACerrors
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_DEM_testbench_DACerrorsInstanceStruct
  *chartInstance, const mxArray *c2_b_dwa_pointer, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_DEM_testbench_DACerrorsInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_DEM_testbench_DACerrorsInstanceStruct
  *chartInstance, const mxArray *c2_dacout, const char_T *c2_identifier);
static real_T c2_d_emlrt_marshallIn(SFc2_DEM_testbench_DACerrorsInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_DEM_testbench_DACerrorsInstanceStruct *
  chartInstance, const mxArray *c2_indx, const char_T *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_DEM_testbench_DACerrorsInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_check_forloop_overflow_error
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance, boolean_T
   c2_overflow);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_g_emlrt_marshallIn(SFc2_DEM_testbench_DACerrorsInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void init_dsm_address_info(SFc2_DEM_testbench_DACerrorsInstanceStruct
  *chartInstance);
  ...
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_DEM_testbench_DACerrors = 0U;
}
  ...
  (SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_DEM_testbench_DACerrors;
   ...
   *c2_st)
{
  ...
  *c2_dacout = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_DEM_testbench_DACerrors = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_DEM_testbench_DACerrors");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_DEM_testbench_DACerrors(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance;
  chartInstance = (SFc2_DEM_testbench_DACerrorsInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_DEM_testbench_DACerrors_get_eml_resolved_functions_info
  (void)
{
...
void sf_c2_DEM_testbench_DACerrors_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(652024864U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(89224676U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1623260861U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2988485507U);
}

mxArray *sf_c2_DEM_testbench_DACerrors_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("gM29fTsjP53CEL89guay1D");
...
mxArray *sf_c2_DEM_testbench_DACerrors_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_DEM_testbench_DACerrors(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"dacout\",},{M[4],M[0],T\"dwa_pointer\",S'l','i','p'{{M1x2[1409 1420],M[0],}}},{M[8],M[0],T\"is_active_c2_DEM_testbench_DACerrors\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_DEM_testbench_DACerrors_get_check_sum(&mxChecksum);
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1749);
        _SFD_CV_INIT_EML_IF(0,1,0,1457,1498,-1,1564);
        _SFD_CV_INIT_EML_IF(0,1,1,1682,1707,-1,1740);
        _SFD_CV_INIT_EML_FOR(0,1,0,1580,1601,1744);

        {
          static int condStart[] = { 1460, 1485 };

          static int condEnd[] = { 1480, 1497 };

          static int pfixExpr[] = { 0, 1, -2 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,1460,1498,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
{
  return "CCV1Le93M42iWbSBlV2JtH";
}

static void sf_opaque_initialize_c2_DEM_testbench_DACerrors(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_DEM_testbench_DACerrorsInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_DEM_testbench_DACerrors
    ((SFc2_DEM_testbench_DACerrorsInstanceStruct*) chartInstanceVar);
  initialize_c2_DEM_testbench_DACerrors
    ((SFc2_DEM_testbench_DACerrorsInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_DEM_testbench_DACerrors(void *chartInstanceVar)
{
  enable_c2_DEM_testbench_DACerrors((SFc2_DEM_testbench_DACerrorsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_DEM_testbench_DACerrors(void *chartInstanceVar)
{
  disable_c2_DEM_testbench_DACerrors((SFc2_DEM_testbench_DACerrorsInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_DEM_testbench_DACerrors(void *chartInstanceVar)
{
  sf_c2_DEM_testbench_DACerrors((SFc2_DEM_testbench_DACerrorsInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_DEM_testbench_DACerrors
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_DEM_testbench_DACerrors
    ((SFc2_DEM_testbench_DACerrorsInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_DEM_testbench_DACerrors();/* state var info */
...
extern void sf_internal_set_sim_state_c2_DEM_testbench_DACerrors(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_DEM_testbench_DACerrors
    ((SFc2_DEM_testbench_DACerrorsInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_DEM_testbench_DACerrors
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_DEM_testbench_DACerrors(S);
}

static void sf_opaque_set_sim_state_c2_DEM_testbench_DACerrors(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_DEM_testbench_DACerrors(S, st);
}

static void sf_opaque_terminate_c2_DEM_testbench_DACerrors(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_DEM_testbench_DACerrorsInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_DEM_testbench_DACerrors
      ((SFc2_DEM_testbench_DACerrorsInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_DEM_testbench_DACerrors
    ((SFc2_DEM_testbench_DACerrorsInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_DEM_testbench_DACerrors(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_DEM_testbench_DACerrors
      ((SFc2_DEM_testbench_DACerrorsInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_DEM_testbench_DACerrors(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3076988964U));
  ssSetChecksum1(S,(183820882U));
  ssSetChecksum2(S,(3296464879U));
  ssSetChecksum3(S,(4024907573U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_DEM_testbench_DACerrors(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_DEM_testbench_DACerrors(SimStruct *S)
{
  SFc2_DEM_testbench_DACerrorsInstanceStruct *chartInstance;
  chartInstance = (SFc2_DEM_testbench_DACerrorsInstanceStruct *)utMalloc(sizeof
    (SFc2_DEM_testbench_DACerrorsInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_DEM_testbench_DACerrorsInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_DEM_testbench_DACerrors;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_DEM_testbench_DACerrors;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_DEM_testbench_DACerrors;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_DEM_testbench_DACerrors;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_DEM_testbench_DACerrors;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_DEM_testbench_DACerrors;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_DEM_testbench_DACerrors;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_DEM_testbench_DACerrors;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_DEM_testbench_DACerrors;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_DEM_testbench_DACerrors;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_DEM_testbench_DACerrors;
...
void c2_DEM_testbench_DACerrors_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_DEM_testbench_DACerrors(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_DEM_testbench_DACerrors(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_DEM_testbench_DACerrors(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_DEM_testbench_DACerrors_method_dispatcher.\n"
