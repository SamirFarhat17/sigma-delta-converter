...
static void initialize_c2_DEM_testbench_DACerrors_9lev
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void initialize_params_c2_DEM_testbench_DACerrors_9lev
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void enable_c2_DEM_testbench_DACerrors_9lev
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void disable_c2_DEM_testbench_DACerrors_9lev
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_DEM_testbench_DACerrors_9lev
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_DEM_testbench_DACerrors_9lev
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void set_sim_state_c2_DEM_testbench_DACerrors_9lev
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_DEM_testbench_DACerrors_9lev
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void sf_c2_DEM_testbench_DACerrors_9lev
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void initSimStructsc2_DEM_testbench_DACerrors_9lev
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void registerMessagesc2_DEM_testbench_DACerrors_9lev
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
...
static real_T c2_emlrt_marshallIn
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance, const mxArray
   *c2_b_dwa_pointer, const char_T *c2_identifier);
...
static real_T c2_c_emlrt_marshallIn
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance, const mxArray
   *c2_dacout, const char_T *c2_identifier);
...
static uint8_T c2_e_emlrt_marshallIn
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance, const mxArray
   *c2_indx, const char_T *c2_identifier);
...
static void c2_check_forloop_overflow_error
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance, boolean_T
   c2_overflow);
  ...
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_DEM_testbench_DACerrors_9lev = 0U;
}
  ...
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal =
    chartInstance->c2_is_active_c2_DEM_testbench_DACerrors_9lev;
   ...
   *c2_st)
{
  ...
  *c2_dacout = c2_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_DEM_testbench_DACerrors_9lev =
    ...
    "is_active_c2_DEM_testbench_DACerrors_9lev");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_DEM_testbench_DACerrors_9lev(chartInstance);
  ...
  (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance)
{
  ...
  c2_b_elems = (real_T (*)[8])ssGetInputPortSignal(chartInstance->S, 3);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance;
  chartInstance = (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *)
    chartInstanceVoid;
  ...
  *c2_inData)
{
  ...
  for (c2_i2 = 0; c2_i2 < 8; c2_i2++) {
    c2_b_inData[c2_i2] = (*(real_T (*)[8])c2_inData)[c2_i2];
  }
...
const mxArray
  *sf_c2_DEM_testbench_DACerrors_9lev_get_eml_resolved_functions_info(void)
{
...
void sf_c2_DEM_testbench_DACerrors_9lev_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4239104896U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2066767325U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(723646077U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(430420088U);
}

mxArray *sf_c2_DEM_testbench_DACerrors_9lev_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("9xn0jcLcvMr3LCg4jDoHFH");
...
mxArray *sf_c2_DEM_testbench_DACerrors_9lev_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_DEM_testbench_DACerrors_9lev(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"dacout\",},{M[4],M[0],T\"dwa_pointer\",S'l','i','p'{{M1x2[1409 1420],M[0],}}},{M[8],M[0],T\"is_active_c2_DEM_testbench_DACerrors_9lev\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_DEM_testbench_DACerrors_9lev_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c2_numele;
          real_T (*c2_elems)[8];
          c2_elems = (real_T (*)[8])ssGetInputPortSignal(chartInstance->S, 3);
...
{
  return "4lxQLqL68na8LFlqXZneHF";
}

static void sf_opaque_initialize_c2_DEM_testbench_DACerrors_9lev(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_DEM_testbench_DACerrors_9lev
    ((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
  initialize_c2_DEM_testbench_DACerrors_9lev
    ((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_DEM_testbench_DACerrors_9lev(void
  *chartInstanceVar)
{
  enable_c2_DEM_testbench_DACerrors_9lev
    ((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_DEM_testbench_DACerrors_9lev(void
  *chartInstanceVar)
{
  disable_c2_DEM_testbench_DACerrors_9lev
    ((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_DEM_testbench_DACerrors_9lev(void
  *chartInstanceVar)
{
  sf_c2_DEM_testbench_DACerrors_9lev
    ((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_DEM_testbench_DACerrors_9lev
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_DEM_testbench_DACerrors_9lev
    ((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_DEM_testbench_DACerrors_9lev();/* state var info */
...
extern void sf_internal_set_sim_state_c2_DEM_testbench_DACerrors_9lev(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_DEM_testbench_DACerrors_9lev
    ((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_DEM_testbench_DACerrors_9lev
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_DEM_testbench_DACerrors_9lev(S);
}

static void sf_opaque_set_sim_state_c2_DEM_testbench_DACerrors_9lev(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_DEM_testbench_DACerrors_9lev(S, st);
}

static void sf_opaque_terminate_c2_DEM_testbench_DACerrors_9lev(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_DEM_testbench_DACerrors_9lev
      ((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_DEM_testbench_DACerrors_9lev
    ((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_DEM_testbench_DACerrors_9lev(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_DEM_testbench_DACerrors_9lev
      ((SFc2_DEM_testbench_DACerrors_9levInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_DEM_testbench_DACerrors_9lev(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(4221608102U));
  ssSetChecksum1(S,(832582797U));
  ssSetChecksum2(S,(50486351U));
  ssSetChecksum3(S,(2115522976U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_DEM_testbench_DACerrors_9lev(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_DEM_testbench_DACerrors_9lev(SimStruct *S)
{
  SFc2_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance;
  chartInstance = (SFc2_DEM_testbench_DACerrors_9levInstanceStruct *)utMalloc
    (sizeof(SFc2_DEM_testbench_DACerrors_9levInstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc2_DEM_testbench_DACerrors_9levInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_DEM_testbench_DACerrors_9lev;
...
void c2_DEM_testbench_DACerrors_9lev_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_DEM_testbench_DACerrors_9lev(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_DEM_testbench_DACerrors_9lev(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_DEM_testbench_DACerrors_9lev(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_DEM_testbench_DACerrors_9lev_method_dispatcher.\n"
