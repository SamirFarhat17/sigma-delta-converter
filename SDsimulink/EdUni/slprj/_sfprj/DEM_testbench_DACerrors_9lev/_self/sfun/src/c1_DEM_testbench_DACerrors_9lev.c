...
static void initialize_c1_DEM_testbench_DACerrors_9lev
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void initialize_params_c1_DEM_testbench_DACerrors_9lev
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void enable_c1_DEM_testbench_DACerrors_9lev
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void disable_c1_DEM_testbench_DACerrors_9lev
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_DEM_testbench_DACerrors_9lev
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_DEM_testbench_DACerrors_9lev
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void set_sim_state_c1_DEM_testbench_DACerrors_9lev
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_DEM_testbench_DACerrors_9lev
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void sf_c1_DEM_testbench_DACerrors_9lev
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void initSimStructsc1_DEM_testbench_DACerrors_9lev
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void registerMessagesc1_DEM_testbench_DACerrors_9lev
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_DEM_testbench_DACerrors_9levInstanceStruct *
  chartInstance, const mxArray *c1_b_ila_pointer, const char_T *c1_identifier,
  real_T c1_y[100]);
static void c1_b_emlrt_marshallIn
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance, const mxArray
   *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[100]);
...
static real_T c1_c_emlrt_marshallIn
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance, const mxArray
   *c1_dacout, const char_T *c1_identifier);
...
static uint8_T c1_e_emlrt_marshallIn
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance, const mxArray
   *c1_indx, const char_T *c1_identifier);
...
static void c1_check_forloop_overflow_error
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance, boolean_T
   c1_overflow);
static void c1_eml_scalar_eg(SFc1_DEM_testbench_DACerrors_9levInstanceStruct
  *chartInstance);
  ...
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_DEM_testbench_DACerrors_9lev = 0U;
}
  ...
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal =
    chartInstance->c1_is_active_c1_DEM_testbench_DACerrors_9lev;
   ...
   *c1_st)
{
  ...
  *c1_dacout = c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c1_is_active_c1_DEM_testbench_DACerrors_9lev =
    ...
    "is_active_c1_DEM_testbench_DACerrors_9lev");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_DEM_testbench_DACerrors_9lev(chartInstance);
  ...
  (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance)
{
  ...
  real_T *c1_b_numele;
  real_T (*c1_b_elems)[8];
  c1_b_elems = (real_T (*)[8])ssGetInputPortSignal(chartInstance->S, 3);
  ...
  while (c1_b_indx <= c1_b_dacin) {
    ...
    c1_dacout += c1_elems[(int32_T)(real_T)_SFD_EML_ARRAY_BOUNDS_CHECK("elems",
      (int32_T)_SFD_INTEGER_CHECK("ipt", c1_ipt), 1, 8, 1, 0) - 1];
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance;
  chartInstance = (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *)
    chartInstanceVoid;
  ...
  *c1_inData)
{
  ...
  for (c1_i9 = 0; c1_i9 < 8; c1_i9++) {
    c1_b_inData[c1_i9] = (*(real_T (*)[8])c1_inData)[c1_i9];
  }
...
void sf_c1_DEM_testbench_DACerrors_9lev_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2117369951U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4125083337U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3766772234U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(277967546U);
}

mxArray *sf_c1_DEM_testbench_DACerrors_9lev_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("sjlCqSEVytamQ9XCCMJGFH");
...
mxArray *sf_c1_DEM_testbench_DACerrors_9lev_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c1_DEM_testbench_DACerrors_9lev(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"dacout\",},{M[4],M[0],T\"ila_pointer\",S'l','i','p'{{M1x2[1409 1420],M[0],}}},{M[8],M[0],T\"is_active_c1_DEM_testbench_DACerrors_9lev\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_DEM_testbench_DACerrors_9lev_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          real_T *c1_numele;
          real_T (*c1_elems)[8];
          c1_elems = (real_T (*)[8])ssGetInputPortSignal(chartInstance->S, 3);
...
{
  return "iZeb78GCk5IEskp3Qf1a5G";
}

static void sf_opaque_initialize_c1_DEM_testbench_DACerrors_9lev(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_DEM_testbench_DACerrors_9lev
    ((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
  initialize_c1_DEM_testbench_DACerrors_9lev
    ((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_DEM_testbench_DACerrors_9lev(void
  *chartInstanceVar)
{
  enable_c1_DEM_testbench_DACerrors_9lev
    ((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_DEM_testbench_DACerrors_9lev(void
  *chartInstanceVar)
{
  disable_c1_DEM_testbench_DACerrors_9lev
    ((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_DEM_testbench_DACerrors_9lev(void
  *chartInstanceVar)
{
  sf_c1_DEM_testbench_DACerrors_9lev
    ((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_DEM_testbench_DACerrors_9lev
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_DEM_testbench_DACerrors_9lev
    ((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_DEM_testbench_DACerrors_9lev();/* state var info */
...
extern void sf_internal_set_sim_state_c1_DEM_testbench_DACerrors_9lev(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_DEM_testbench_DACerrors_9lev
    ((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_DEM_testbench_DACerrors_9lev
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_DEM_testbench_DACerrors_9lev(S);
}

static void sf_opaque_set_sim_state_c1_DEM_testbench_DACerrors_9lev(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_DEM_testbench_DACerrors_9lev(S, st);
}

static void sf_opaque_terminate_c1_DEM_testbench_DACerrors_9lev(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c1_DEM_testbench_DACerrors_9lev
      ((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_DEM_testbench_DACerrors_9lev
    ((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_DEM_testbench_DACerrors_9lev(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_DEM_testbench_DACerrors_9lev
      ((SFc1_DEM_testbench_DACerrors_9levInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_DEM_testbench_DACerrors_9lev(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3022984752U));
  ssSetChecksum1(S,(4116824123U));
  ssSetChecksum2(S,(713489087U));
  ssSetChecksum3(S,(1063609467U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_DEM_testbench_DACerrors_9lev(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_DEM_testbench_DACerrors_9lev(SimStruct *S)
{
  SFc1_DEM_testbench_DACerrors_9levInstanceStruct *chartInstance;
  chartInstance = (SFc1_DEM_testbench_DACerrors_9levInstanceStruct *)utMalloc
    (sizeof(SFc1_DEM_testbench_DACerrors_9levInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_DEM_testbench_DACerrors_9lev;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_DEM_testbench_DACerrors_9lev;
...
void c1_DEM_testbench_DACerrors_9lev_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_DEM_testbench_DACerrors_9lev(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_DEM_testbench_DACerrors_9lev(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_DEM_testbench_DACerrors_9lev(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_DEM_testbench_DACerrors_9lev_method_dispatcher.\n"
