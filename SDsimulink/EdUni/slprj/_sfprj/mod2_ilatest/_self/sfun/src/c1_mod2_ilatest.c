...
#include <stddef.h>
#include "blas.h"
#include "mod2_ilatest_sfun.h"
#include "c1_mod2_ilatest.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "mod2_ilatest_sfun_debug_macros.h"
...
static void initialize_c1_mod2_ilatest(SFc1_mod2_ilatestInstanceStruct
  *chartInstance);
static void initialize_params_c1_mod2_ilatest(SFc1_mod2_ilatestInstanceStruct
  *chartInstance);
static void enable_c1_mod2_ilatest(SFc1_mod2_ilatestInstanceStruct
  *chartInstance);
static void disable_c1_mod2_ilatest(SFc1_mod2_ilatestInstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_mod2_ilatest
  (SFc1_mod2_ilatestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_mod2_ilatest
  (SFc1_mod2_ilatestInstanceStruct *chartInstance);
static void set_sim_state_c1_mod2_ilatest(SFc1_mod2_ilatestInstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_mod2_ilatest(SFc1_mod2_ilatestInstanceStruct
  *chartInstance);
static void sf_c1_mod2_ilatest(SFc1_mod2_ilatestInstanceStruct *chartInstance);
static void initSimStructsc1_mod2_ilatest(SFc1_mod2_ilatestInstanceStruct
  *chartInstance);
static void registerMessagesc1_mod2_ilatest(SFc1_mod2_ilatestInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_mod2_ilatestInstanceStruct *chartInstance,
  const mxArray *c1_b_ila_pointer, const char_T *c1_identifier, real_T c1_y[100]);
static void c1_b_emlrt_marshallIn(SFc1_mod2_ilatestInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[100]);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_mod2_ilatestInstanceStruct
  *chartInstance, const mxArray *c1_dacout, const char_T *c1_identifier);
static real_T c1_d_emlrt_marshallIn(SFc1_mod2_ilatestInstanceStruct
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_mod2_ilatestInstanceStruct
  *chartInstance, const mxArray *c1_indx, const char_T *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_mod2_ilatestInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[14]);
static void c1_check_forloop_overflow_error(SFc1_mod2_ilatestInstanceStruct
  *chartInstance, boolean_T c1_overflow);
static void c1_eml_scalar_eg(SFc1_mod2_ilatestInstanceStruct *chartInstance);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_g_emlrt_marshallIn(SFc1_mod2_ilatestInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void init_dsm_address_info(SFc1_mod2_ilatestInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_mod2_ilatest = 0U;
}
  ...
  (SFc1_mod2_ilatestInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_mod2_ilatest;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_dacout = c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c1_is_active_c1_mod2_ilatest = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_mod2_ilatest");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_mod2_ilatest(chartInstance);
...
static void sf_c1_mod2_ilatest(SFc1_mod2_ilatestInstanceStruct *chartInstance)
{
  ...
  *c1_b_dacout = c1_dacout;
  ...
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_mod2_ilatestMachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_mod2_ilatestInstanceStruct *chartInstance;
  chartInstance = (SFc1_mod2_ilatestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_mod2_ilatest_get_eml_resolved_functions_info(void)
{
...
void sf_c1_mod2_ilatest_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3825067580U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3803646149U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2226501189U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(494745606U);
}

mxArray *sf_c1_mod2_ilatest_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("1ZR3WcYnzZ3ERxhGEiuSJG");
...
mxArray *sf_c1_mod2_ilatest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c1_mod2_ilatest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"dacout\",},{M[4],M[0],T\"ila_pointer\",S'l','i','p'{{M1x2[1410 1421],M[0],}}},{M[8],M[0],T\"is_active_c1_mod2_ilatest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_mod2_ilatest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_mod2_ilatestInstanceStruct *chartInstance;
    chartInstance = (SFc1_mod2_ilatestInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_mod2_ilatestMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_mod2_ilatestMachineNumber_,
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2224);
        _SFD_CV_INIT_EML_SATURATION(0,1,0,1469,-1,1476);
        _SFD_CV_INIT_EML_IF(0,1,0,1690,1713,-1,1781);
        _SFD_CV_INIT_EML_IF(0,1,1,1783,1800,-1,1864);
        _SFD_CV_INIT_EML_FOR(0,1,0,1911,1932,2188);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _mod2_ilatestMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "4yP2Os2qGd1JiOFu0Lt05D";
}

static void sf_opaque_initialize_c1_mod2_ilatest(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_mod2_ilatestInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_mod2_ilatest((SFc1_mod2_ilatestInstanceStruct*)
    chartInstanceVar);
  initialize_c1_mod2_ilatest((SFc1_mod2_ilatestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_mod2_ilatest(void *chartInstanceVar)
{
  enable_c1_mod2_ilatest((SFc1_mod2_ilatestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_mod2_ilatest(void *chartInstanceVar)
{
  disable_c1_mod2_ilatest((SFc1_mod2_ilatestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_mod2_ilatest(void *chartInstanceVar)
{
  sf_c1_mod2_ilatest((SFc1_mod2_ilatestInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_mod2_ilatest(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_mod2_ilatest
    ((SFc1_mod2_ilatestInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_mod2_ilatest();/* state var info */
...
extern void sf_internal_set_sim_state_c1_mod2_ilatest(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_mod2_ilatest((SFc1_mod2_ilatestInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_mod2_ilatest(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_mod2_ilatest(S);
}

static void sf_opaque_set_sim_state_c1_mod2_ilatest(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c1_mod2_ilatest(S, st);
}

static void sf_opaque_terminate_c1_mod2_ilatest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_mod2_ilatestInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_mod2_ilatest_optimization_info();
    }

    finalize_c1_mod2_ilatest((SFc1_mod2_ilatestInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_mod2_ilatest((SFc1_mod2_ilatestInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_mod2_ilatest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_mod2_ilatest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_mod2_ilatest_optimization_info();
  ...
  ssSetChecksum0(S,(2396059936U));
  ssSetChecksum1(S,(2910481872U));
  ssSetChecksum2(S,(2175991379U));
  ssSetChecksum3(S,(2202817666U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_mod2_ilatest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_mod2_ilatest(SimStruct *S)
{
  SFc1_mod2_ilatestInstanceStruct *chartInstance;
  chartInstance = (SFc1_mod2_ilatestInstanceStruct *)utMalloc(sizeof
    (SFc1_mod2_ilatestInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_mod2_ilatestInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_mod2_ilatest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_mod2_ilatest;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_mod2_ilatest;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_mod2_ilatest;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_mod2_ilatest;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_mod2_ilatest;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_mod2_ilatest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_mod2_ilatest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_mod2_ilatest;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_mod2_ilatest;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_mod2_ilatest;
...
void c1_mod2_ilatest_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_mod2_ilatest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_mod2_ilatest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_mod2_ilatest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_mod2_ilatest_method_dispatcher.\n"
